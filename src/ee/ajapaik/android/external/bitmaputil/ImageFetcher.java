...
package ee.ajapaik.android.external.bitmaputil;
...
public class ImageFetcher extends ImageResizer {
     ...
     * @param imageHeight
     */
    public ImageFetcher(Context context, int imageWidth, int imageHeight, boolean rotate) {
        super(context, imageWidth, imageHeight, rotate);
        init(context);
    }
